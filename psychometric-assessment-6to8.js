...
if (document.location.pathname.includes('psychometric-assessment-6to8.html')) {
    ...
    function setupEventListeners() {
        ...
        if (startActivityBtn) {
            startActivityBtn.addEventListener('click', () => {
                ...
                window.location.href = 'activity-assessment-6to8.html?category=scenario';
            });
        }
    }
    ...
    function moveToNextCategoryOrActivity() {
        ...
        if (nextCategoryIndex < psychoCategories.length) {
            window.location.href = `psychometric-assessment-6to8.html?category=${psychoCategories[nextCategoryIndex]}`;
        } else {
